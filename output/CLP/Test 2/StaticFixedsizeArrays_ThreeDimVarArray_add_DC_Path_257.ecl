...
(Idx0_1 #= (Idx0+1)),
(Idx0_1 #=< D1 - 1+ 1),
sueuencetolist(1,D1,List_2065857933),nth1(Idx0_1,List_2065857933,Var_2065857933_1),(It_1 = Var_2065857933_1),
(Acc2_1 = true),
(Idx1_2 #= 1),
(Idx1_2 #=< D2 - 1+ 1),
sueuencetolist(1,D2,List_1914301543),nth1(Idx1_2,List_1914301543,Var_1914301543_1),(It2_1 = Var_1914301543_1),
(Acc3_1 = true),
(Idx2_3 #= 1),
(Idx2_3 #=< D3 - 1+ 1),
sueuencetolist(1,D3,List_1157726741),nth1(Idx2_3,List_1157726741,Var_1157726741_2),(It3_2 = Var_1157726741_2),
(Var_1708570683_3 is Arg_data[It_1,It2_1,It3_2]),(Var_225472281_3 is Self_data[It_1,It2_1,It3_2]),(Var_817348612_3 is Result_data[It_1,It2_1,It3_2]),(Var_817348612_3 #= (Var_225472281_3+Var_1708570683_3)),
(Idx2_4 #= (Idx2_3+1)),
(Idx2_4 #=< D3 - 1+ 1),
sueuencetolist(1,D3,List_1157726741),nth1(Idx2_4,List_1157726741,Var_1157726741_3),(It3_3 = Var_1157726741_3),
(Var_1708570683_4 is Arg_data[It_1,It2_1,It3_3]),(Var_225472281_4 is Self_data[It_1,It2_1,It3_3]),(Var_817348612_4 is Result_data[It_1,It2_1,It3_3]),(Var_817348612_4 #= (Var_225472281_4+Var_1708570683_4)),
(Idx2_5 #= (Idx2_4+1)),
(Idx2_5 #> D3 - 1+ 1),
(Idx1_3 #= (Idx1_2+1)),
(Idx1_3 #> D2 - 1+ 1),
