...
nth1(2,Arg_dimensionSizes,Var_1364913072),
nth1(2,Self_dimensionSizes,Var_232307208),
nth1(1,Arg_dimensionSizes,Var_609962972),
nth1(1,Self_dimensionSizes,Var_1818544933),
length(Arg_dimensionSizes,Var_1793436274),
length(Self_dimensionSizes,Var_572868060),
...
nth1(2,Arg_dimensionSizes,Var_966739377),
nth1(2,Self_dimensionSizes,Var_952562199),
nth1(1,Arg_dimensionSizes,Var_1199673596),
nth1(1,Self_dimensionSizes,Var_2044903525),
length(Arg_dimensionSizes,Var_982757413),
length(Self_dimensionSizes,Var_902478634),
(((((Var_902478634 #\= Var_982757413) , (Var_2044903525 #= Var_1199673596)) , (Var_952562199 #= Var_966739377)) ; (((Var_762476028 #= Var_1926343982) , (Var_1499136125 #\= Var_1364767791)) , (Var_371800738 #= Var_1549725679))) ; (((Var_572868060 #= Var_1793436274) , (Var_1818544933 #= Var_609962972)) , (Var_232307208 #\= Var_1364913072))),
