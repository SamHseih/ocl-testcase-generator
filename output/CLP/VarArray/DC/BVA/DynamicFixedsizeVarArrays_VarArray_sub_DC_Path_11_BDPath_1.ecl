...
dynamicFixedsizeVarArrays_VarArray_sub_DC_Path_11_BDPath_1(Self,Arg,Result):-
...
(Idx0_4 #= (Idx0_3+1)),
(Idx0_4 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_2127036371),nth1(Idx0_4,List_2127036371,Var_2127036371_4),(It_4 = Var_2127036371_4),
...
(Idx0_5 #= (Idx0_4+1)),
(Idx0_5 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_2127036371),nth1(Idx0_5,List_2127036371,Var_2127036371_5),(It_5 = Var_2127036371_5),
...
(Idx0_6 #= (Idx0_5+1)),
(Idx0_6 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_2127036371),nth1(Idx0_6,List_2127036371,Var_2127036371_6),(It_6 = Var_2127036371_6),
...
(Idx0_7 #= (Idx0_6+1)),
(Idx0_7 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_2127036371),nth1(Idx0_7,List_2127036371,Var_2127036371_7),(It_7 = Var_2127036371_7),
...
(Idx0_8 #= (Idx0_7+1)),
(Idx0_8 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_2127036371),nth1(Idx0_8,List_2127036371,Var_2127036371_8),(It_8 = Var_2127036371_8),
getArrayElement(Arg_data,[It_8],Var_1529060733_9),getArrayElement(Self_data,[It_8],Var_106374177_9),getArrayElement(Result_data,[It_8],Var_1803669141_9),(Var_1803669141_9 #= (Var_106374177_9-Var_1529060733_9)),
(Idx0_9 #= (Idx0_8+1)),
(Idx0_9 #> Dim1 - 1+ 1),
