...
(Idx0_1 #= (Idx0+1)),
(Idx0_1 #=< D1 - 1+ 1),
sequencetoList(1,D1,List_957465255),nth1(Idx0_1,List_957465255,Var_957465255_1),(It_1 = Var_957465255_1),
(Acc2_1 = true),
(Idx1_2 #= 1),
(Idx1_2 #=< D2 - 1+ 1),
sequencetoList(1,D2,List_787738361),nth1(Idx1_2,List_787738361,Var_787738361_1),(It2_1 = Var_787738361_1),
(Acc3_1 = true),
(Idx2_2 #= 1),
(Idx2_2 #=< D3 - 1+ 1),
