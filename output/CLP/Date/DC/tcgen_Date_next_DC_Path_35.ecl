...
tcgen_Date_next_DC_Path_35(Self,Result):-
...
((((Self_month #\= 4) , (Self_month #\= 6)) , (Self_month #\= 9)) , (Self_month #\= 11)),
delay_mod(Self_year,100, Var_2101153819),
delay_mod(Self_year,4, Var_51152513),
delay_mod(Self_year,100, Var_1558103808),
delay_mod(Self_year,4, Var_1828873985),
delay_mod(Self_year,400, Var_2024415090),
((Var_2024415090 #\= 0) , (((Var_1828873985 #\= 0) , (Var_1558103808 #\= 0)) ; ((Var_51152513 #= 0) , (Var_2101153819 #= 0)))),
(Self_day #= 28),
