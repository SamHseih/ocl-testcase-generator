...
tcgen_Date_Date_DC_Path_2(Self,Y,M,D):-
...
((Var_1990098664 #= 0) ; ((Var_313540687 #= 0) , (Var_1100767002 #\= 0))),(D #< 30));(delay_mod(Y,100, Var_1383524016),
delay_mod(Y,4, Var_1907431275),
delay_mod(Y,100, Var_1637061418),
delay_mod(Y,4, Var_1686100174),
delay_mod(Y,400, Var_22671767),
((Var_22671767 #\= 0) , (((Var_1686100174 #\= 0) , (Var_1637061418 #\= 0)) ; ((Var_1907431275 #= 0) , (Var_1383524016 #= 0)))),(D #< 29)))))))),
