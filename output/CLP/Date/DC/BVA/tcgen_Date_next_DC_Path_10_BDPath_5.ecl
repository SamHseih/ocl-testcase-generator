...
delay_mod(Self_year,100, Var_283318938),
delay_mod(Self_year,4, Var_320304382),
delay_mod(Self_year,100, Var_361571968),
delay_mod(Self_year,4, Var_2005169944),
delay_mod(Self_year,400, Var_2134607032),
((Var_2134607032 #\= 0) , (((Var_2005169944 #\= 0) , (Var_361571968 #\= 0)) ; ((Var_320304382 #= 0) , (Var_283318938 #= 0)))),
(Self_day #\= 28),
