...
delay_mod(Self_year,100, Var_171802996),
delay_mod(Self_year,4, Var_464064894),
delay_mod(Self_year,100, Var_1932274274),
delay_mod(Self_year,4, Var_657381435),
delay_mod(Self_year,400, Var_1107217291),
((Var_1107217291 #\= 0) , (((Var_657381435 #\= 0) , (Var_1932274274 #\= 0)) ; ((Var_464064894 #= 0) , (Var_171802996 #= 0)))),
(Self_day #= 28),
