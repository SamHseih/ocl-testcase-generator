...
delay_mod(Self_year,100, Var_931480286),
delay_mod(Self_year,4, Var_926434463),
delay_mod(Self_year,100, Var_1776409896),
delay_mod(Self_year,4, Var_297602875),
delay_mod(Self_year,400, Var_204684384),
((Var_204684384 #\= 0) , (((Var_297602875 #\= 0) , (Var_1776409896 #\= 0)) ; ((Var_926434463 #= 0) , (Var_931480286 #= 0)))),
(Self_day #= 28),
