...
delay_mod(Self_year,100, Var_2074820378),
delay_mod(Self_year,4, Var_1132307065),
delay_mod(Self_year,400, Var_599984672),
((Var_599984672 #= 0) ; ((Var_1132307065 #= 0) , (Var_2074820378 #\= 0))),
(Self_day #= 29),
(Result #= Self_day),
