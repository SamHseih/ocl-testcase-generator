...
delay_mod(Self_year,100, Var_900636745),
delay_mod(Self_year,4, Var_1912960603),
delay_mod(Self_year,400, Var_1201173334),
((Var_1201173334 #= 0) ; ((Var_1912960603 #= 0) , (Var_900636745 #\= 0))),
(Self_day #=< 29),
(Result #= Self_month),
