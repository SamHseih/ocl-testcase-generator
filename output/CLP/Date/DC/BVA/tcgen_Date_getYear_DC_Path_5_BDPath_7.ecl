...
tcgen_Date_getYear_DC_Path_5_BDPath_7(Self,Result):-
...
delay_mod(Self_year,100, Var_224100622),
delay_mod(Self_year,4, Var_1138410383),
delay_mod(Self_year,100, Var_875313400),
delay_mod(Self_year,4, Var_210281271),
delay_mod(Self_year,400, Var_1560940633),
((Var_1560940633 #\= 0) , (((Var_210281271 #\= 0) , (Var_875313400 #\= 0)) ; ((Var_1138410383 #= 0) , (Var_224100622 #= 0)))),
(Self_day #=< 28),
(Result #= Self_year),
