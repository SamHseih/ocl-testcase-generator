...
tcgen_Date_next_DC_Path_9_BDPath_6(Self,Result):-
...
delay_mod(Self_year,100, Var_1923598304),
delay_mod(Self_year,4, Var_776700275),
delay_mod(Self_year,100, Var_118394766),
delay_mod(Self_year,4, Var_386163331),
delay_mod(Self_year,400, Var_1540374340),
((Var_1540374340 #\= 0) , (((Var_386163331 #\= 0) , (Var_118394766 #\= 0)) ; ((Var_776700275 #= 0) , (Var_1923598304 #= 0)))),
(Self_day #= 28),
