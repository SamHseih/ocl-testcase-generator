...
delay_mod(Self_year,100, Var_762476028),
delay_mod(Self_year,4, Var_966739377),
delay_mod(Self_year,100, Var_952562199),
delay_mod(Self_year,4, Var_1199673596),
delay_mod(Self_year,400, Var_2044903525),
((Var_2044903525 #\= 0) , (((Var_1199673596 #\= 0) , (Var_952562199 #\= 0)) ; ((Var_966739377 #= 0) , (Var_762476028 #= 0)))),
(Self_day #\= 28),
