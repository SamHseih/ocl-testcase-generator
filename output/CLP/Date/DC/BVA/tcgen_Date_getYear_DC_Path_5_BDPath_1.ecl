...
delay_mod(Self_year,100, Var_710190911),
delay_mod(Self_year,4, Var_379645464),
delay_mod(Self_year,400, Var_1030684756),
((Var_1030684756 #\= 0) , (((Var_379645464 #\= 0) , (Var_710190911 #\= 0)) ; ((Var_1898155970 #= 0) , (Var_262445056 #= 0)))),
(Self_day #=< 28),
(Result #= Self_year),
