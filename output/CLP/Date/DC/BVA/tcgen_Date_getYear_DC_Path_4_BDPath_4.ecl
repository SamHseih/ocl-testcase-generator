...
delay_mod(Self_year,100, Var_1353530305),
delay_mod(Self_year,4, Var_574268151),
delay_mod(Self_year,400, Var_1832532108),
((Var_1832532108 #= 0) ; ((Var_574268151 #= 0) , (Var_1353530305 #\= 0))),
(Self_day #=< 29),
(Result #= Self_year),
