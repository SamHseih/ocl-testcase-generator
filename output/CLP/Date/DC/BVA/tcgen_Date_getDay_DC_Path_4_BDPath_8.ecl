...
delay_mod(Self_year,100, Var_1426963578),
delay_mod(Self_year,4, Var_556281560),
delay_mod(Self_year,400, Var_915500720),
((Var_915500720 #= 0) ; ((Var_556281560 #= 0) , (Var_1426963578 #\= 0))),
(Self_day #=< 29),
(Result #= Self_day),
