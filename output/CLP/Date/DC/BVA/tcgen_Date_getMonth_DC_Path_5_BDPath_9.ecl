...
delay_mod(Self_year,100, Var_1515638188),
delay_mod(Self_year,4, Var_2087785333),
delay_mod(Self_year,400, Var_1473205473),
((Var_1473205473 #\= 0) , (((Var_2087785333 #\= 0) , (Var_1515638188 #\= 0)) ; ((Var_1497018177 #= 0) , (Var_1421866327 #= 0)))),
(Self_day #= 28),
(Result #= Self_month),
