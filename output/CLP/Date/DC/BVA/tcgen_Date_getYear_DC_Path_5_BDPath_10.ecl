...
delay_mod(Self_year,100, Var_359368949),
delay_mod(Self_year,4, Var_1006227006),
delay_mod(Self_year,400, Var_375457936),
((Var_375457936 #\= 0) , (((Var_1006227006 #\= 0) , (Var_359368949 #\= 0)) ; ((Var_621300254 #= 0) , (Var_198499365 #= 0)))),
(Self_day #< 28),
(Result #= Self_year),
