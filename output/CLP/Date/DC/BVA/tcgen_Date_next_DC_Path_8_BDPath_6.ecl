...
tcgen_Date_next_DC_Path_8_BDPath_6(Self,Result):-
...
delay_mod(Self_year,100, Var_1378084334),
delay_mod(Self_year,4, Var_200224114),
delay_mod(Self_year,400, Var_1773283386),
((Var_1773283386 #= 0) ; ((Var_200224114 #= 0) , (Var_1378084334 #\= 0))),
(Self_day #\= 29),
