...
tcgen_Date_next_DC_Path_7_BDPath_5(Self,Result):-
...
delay_mod(Self_year,100, Var_842741472),
delay_mod(Self_year,4, Var_1156304131),
delay_mod(Self_year,400, Var_1766505436),
((Var_1766505436 #= 0) ; ((Var_1156304131 #= 0) , (Var_842741472 #\= 0))),
(Self_day #= 29),
