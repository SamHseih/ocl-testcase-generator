...
delay_mod(Self_year,100, Var_375466577),
delay_mod(Self_year,4, Var_1423983012),
delay_mod(Self_year,100, Var_746074699),
delay_mod(Self_year,4, Var_127791068),
delay_mod(Self_year,400, Var_405896924),
((Var_405896924 #\= 0) , (((Var_127791068 #\= 0) , (Var_746074699 #\= 0)) ; ((Var_1423983012 #= 0) , (Var_375466577 #= 0)))),
(Self_day #=< 28),
(Result #= Self_month),
