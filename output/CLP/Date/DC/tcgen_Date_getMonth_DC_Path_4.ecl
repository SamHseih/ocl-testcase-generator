...
delay_mod(Self_year,100, Var_1448061896),
delay_mod(Self_year,4, Var_294247762),
delay_mod(Self_year,400, Var_232307208),
((Var_232307208 #= 0) ; ((Var_294247762 #= 0) , (Var_1448061896 #\= 0))),
(Self_day #=< 29),
(Result #= Self_month),
