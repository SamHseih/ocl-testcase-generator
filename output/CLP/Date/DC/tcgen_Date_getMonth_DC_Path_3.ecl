...
tcgen_Date_getMonth_DC_Path_3(Self,Result):-
...
((Var_1546693040 #= 0) ; ((Var_1667148529 #= 0) , (Var_836220863 #\= 0))),(Self_day #=< 29));(delay_mod(Self_year,100, Var_1668016508),
delay_mod(Self_year,4, Var_1353070773),
delay_mod(Self_year,100, Var_404214852),
delay_mod(Self_year,4, Var_1822971466),
delay_mod(Self_year,400, Var_1354003114),
((Var_1354003114 #\= 0) , (((Var_1822971466 #\= 0) , (Var_404214852 #\= 0)) ; ((Var_1353070773 #= 0) , (Var_1668016508 #= 0)))),(Self_day #=< 28)))))))),
