...
tcgen_Date_getYear_DC_Path_3(Self,Result):-
...
((Var_1378084334 #= 0) ; ((Var_2025221430 #= 0) , (Var_2095303566 #\= 0))),(Self_day #=< 29));(delay_mod(Self_year,100, Var_1704629915),
delay_mod(Self_year,4, Var_1989184704),
delay_mod(Self_year,100, Var_611572016),
delay_mod(Self_year,4, Var_889486595),
delay_mod(Self_year,400, Var_77269878),
((Var_77269878 #\= 0) , (((Var_889486595 #\= 0) , (Var_611572016 #\= 0)) ; ((Var_1989184704 #= 0) , (Var_1704629915 #= 0)))),(Self_day #=< 28)))))))),
