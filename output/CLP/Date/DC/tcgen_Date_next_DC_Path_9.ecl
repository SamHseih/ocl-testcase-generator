...
delay_mod(Self_year,100, Var_1646464088),
delay_mod(Self_year,4, Var_752001567),
delay_mod(Self_year,100, Var_777379084),
delay_mod(Self_year,4, Var_1950701640),
delay_mod(Self_year,400, Var_243194708),
((Var_243194708 #\= 0) , (((Var_1950701640 #\= 0) , (Var_777379084 #\= 0)) ; ((Var_752001567 #= 0) , (Var_1646464088 #= 0)))),
(Self_day #= 28),
