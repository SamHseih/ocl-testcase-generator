...
delay_mod(Self_year,100, Var_173214986),
delay_mod(Self_year,4, Var_27362884),
delay_mod(Self_year,400, Var_1523553211),
((Var_1523553211 #\= 0) , (((Var_27362884 #\= 0) , (Var_173214986 #\= 0)) ; ((Var_790722099 #= 0) , (Var_1223850219 #= 0)))),
(Self_day #=< 28),
(Result #= Self_month),
