...
staticFixedsizeArrays_Array_mul_DC_Path_6(Self,Arg,Result):-
...
(Idx0 #= 1),
(Idx0 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_496729294),nth1(Idx0,List_496729294,Var_496729294),(It = Var_496729294),
...
(Idx0_1 #= (Idx0+1)),
(Idx0_1 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_496729294),nth1(Idx0_1,List_496729294,Var_496729294_1),(It_1 = Var_496729294_1),
...
(Idx0_2 #= (Idx0_1+1)),
(Idx0_2 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_496729294),nth1(Idx0_2,List_496729294,Var_496729294_2),(It_2 = Var_496729294_2),
...
(Idx0_3 #= (Idx0_2+1)),
(Idx0_3 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_496729294),nth1(Idx0_3,List_496729294,Var_496729294_3),(It_3 = Var_496729294_3),
...
(Idx0_4 #= (Idx0_3+1)),
(Idx0_4 #=< Dim1 - 1+ 1),
sequencetoList(1,Dim1,List_496729294),nth1(Idx0_4,List_496729294,Var_496729294_4),(It_4 = Var_496729294_4),
