 ...
 * An abstract base class that houses common functionality for symbols like classes and functions
 * that are both symbols and scopes. There is some common cut and paste functionality with
 * {@link BaseSymbol} because of a lack of multiple inheritance in Java but it is minimal.
 */
public abstract class SymbolWithScope extends BaseScope implements Symbol, Scope {
  ...
  /**
   * Return the name prefixed with the name of its enclosing scope using '.' (dot) as the scope
   * separator.
   */
  ...
  /**
   * Return the fully qualified name includes all scopes from the root down to this particular
   * symbol.
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (obj == this) {// if same ref return true.
       ...
       * If obj is a Symbol and its name is the same as this.name, return true; otherwise, return
       * false.
       */
