 ...
 * A symbol representing the class. It is a kind of data aggregate that has much in common with a
 * struct.
 */
public class ClassSymbol extends DataAggregateSymbol {
  ...
  public ClassSymbol(String name, String umlID) {
    super(name, umlID);
  }

  /**
   * Return the ClassSymbol associated with superClassName or null if superclass is not resolved
   * looking up the enclosing scope chain.
   */
  ...
  /**
   * Look for a member with this name in this scope or any super class. Return null if no member
   * found.
   */
  @Override
  ...
  /**
   * Look for a field with this name in this scope or any super class. Return null if no field
   * found.
   */
  @Override
  ...
  /**
   * Look for a method with this name in this scope or any super class. Return null if no method
   * found.
   */
  ...
  // add by Sam Hsieh Date: 2025-04-01
  @Override
