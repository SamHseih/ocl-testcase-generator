...
/** Ref: https://github.com/antlr/symtab/blob/master/doc/symtab.png 
...
public interface Scope {
	...
	/*
	//add by Sam Hsieh  Date: 2025-04-01 same as getSymbol
	Symbol getIdSymbol(String umlId);

	//add by Sam Hsieh  Date: 2025-04-01 same as resolve
	Symbol resolveById(String umlId);

	//add by Sam Hsieh  Date: 2025-04-01 same as getSymbols
	List<? extends Symbol> getIdSymbols();
	
	//add by Sam Hsieh  Date: 2025-04-01 same as getNumberOfidSymbols
	int getNumberOfidSymbols();

	//add by Sam Hsieh  Date: 2025-04-01 same as getSymbolNames
	Set<String> getidSymbolIDs();

	//add by Sam Hsieh  Date: 2025-04-01 same as define
	void defineById (Symbol sym) throws IllegalArgumentException;*/
