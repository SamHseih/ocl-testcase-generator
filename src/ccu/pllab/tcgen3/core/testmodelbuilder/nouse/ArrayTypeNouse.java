...
/**
 * Represents an array type in the symbol table. This class extends BaseSymbol and implements the
 * Type interface. It contains information about the element type, dimensions, and number of
...
public class ArrayTypeNouse<T> extends BaseSymbol implements Type {
  ...
  private List<Integer> dimensionSizeList;// Constraint Solver will use this to determine the size
                                          // of the array
