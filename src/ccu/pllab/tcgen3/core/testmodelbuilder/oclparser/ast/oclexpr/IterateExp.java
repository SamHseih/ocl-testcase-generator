...
public class IterateExp extends LoopExp {
  ...
  /**
   * OCL «iterate» collection->iterate(elem: Type; acc: Type = expression |
   * expression-with-elem-and-acc) <br>
   * IterateExp<br>
  ...
  public ASTree clone() {
    ...
    // 2️⃣ 建立新實例
    IterateExp clone = new IterateExp(clonedChildren, this.isMarkedPre(), // 來自 FeatureCallExp
