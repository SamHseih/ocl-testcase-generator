...
public class UnaryExp extends ASTList implements Expression {
    ...
    public ASTree getExpr() { return child(0); }
    
    @Override public String toString() { return "(" + operator + " " + getExpr() + ")"; }
    @Override public String toAstString() { return "(" + operator + " " + getExpr() + ")"; }
    @Override public String toClgString() { return "(" + operator + " " + getExpr() + ")"; }
