 ...
 * A FeatureCallExp expression may have three different productions. Which one is chosen depends on
 * the disambiguating rules defined in each of the alternatives.<br>
...
public class PropertyCallExp extends FeatureCallExp {
  ...
  public ASTree clone() {
    ...
    // 2 建立新節點
    return new PropertyCallExp(clonedSource, // List<ASTree> source
