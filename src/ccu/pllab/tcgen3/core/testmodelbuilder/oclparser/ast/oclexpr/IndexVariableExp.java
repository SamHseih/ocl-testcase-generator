...
public class IndexVariableExp extends VariableExp {
  ...
  /**
   * This only used for indexed variable , at visitIterateExpContextr{@code DcCLGBuilderVisitor}
   */
   ...
   * 
   * public void nextIndex() { // Increment the index for the next iteration this.index++; }
   */
