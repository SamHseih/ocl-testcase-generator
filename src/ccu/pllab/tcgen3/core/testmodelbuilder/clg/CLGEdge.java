...
public class CLGEdge {
  ...
  public static class Builder {
    ...
    public Builder type(CLGEdgeType t) {
      this.type = t;
      return this;
    }
    ...
    public Builder iterationIndex(int idx) {
      this.iterationIndex = idx;
      return this;
    }

    public CLGEdge build() {
      return new CLGEdge(this);
    }
  }
  ...
  public CLGNode getFrom() {
    return from;
  }

  public CLGNode getTo() {
    return to;
  }

  public CLGEdgeType getType() {
    return type;
  }
  ...
  public String toString() {
    if (type == CLGEdgeType.ITERATION) {
      ...
      return this.label + "#" + id;// + "(" + from.id() + "→" + to.id() +
