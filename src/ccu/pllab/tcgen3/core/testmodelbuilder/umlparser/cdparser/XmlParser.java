        ...
        for (int i = 0; i < packagedElements.getLength(); i++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if ("uml:Class".equals(xmiType)) {
                    ...
                    classInfo.append("Class Name: ").append(className)
                             .append(", ID: ").append(classId)
                             .append("\n");
                    ...
                    for (int j = 0; j < ownedOperations.getLength(); j++) {
                        ...
                        if (opNode.getNodeType() == Node.ELEMENT_NODE
                                ...
                                if (paramNode.getNodeType() == Node.ELEMENT_NODE
                                    ...
                                    if ("return".equals(direction)) {
                                        ...
                                        paramsBuilder.append("      Parameter:\n")
                                                     ...
                                                     .append("        type=").append(paramType).append("\n")
                            ...
                            classInfo.append("  Owned Operation:\n")
                                     .append("    name=").append(opName).append("\n")
        ...
        for (int i = 0; i < packagedElements.getLength(); i++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if ("uml:Package".equals(xmiType) && "Primitivetype".equals(name)) {
                    primitivePackageInfo.append("Package (Primitivetype) Name: ")
                                        .append(name).append("\n");

                    // Get child elements under that Package (e.g., <packagedElement xmi:type="uml:PrimitiveType">)
                    ...
                    for (int j = 0; j < subNodes.getLength(); j++) {
                        ...
                        if (subNode.getNodeType() == Node.ELEMENT_NODE
                            ...
                            primitivePackageInfo.append("  PrimitiveType: ")
                                                .append(subElemName).append("\n");
                        }
                    }
        ...
        for (int i = 0; i < packagedElements.getLength(); i++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if ("uml:Package".equals(xmiType) && "Referencetype".equals(name)) {
                    referencePackageInfo.append("Package (Referencetype) Name: ")
                                        .append(name).append("\n");
                    ...
                    for (int j = 0; j < subNodes.getLength(); j++) {
                        ...
                        if (subNode.getNodeType() == Node.ELEMENT_NODE
                            ...
                            Element subElem = (Element) subNode;
                            String subElemName = subElem.getAttribute("name");
                            referencePackageInfo.append("  DataType: ")
                                                .append(subElemName).append("\n");
                        }
                    }
