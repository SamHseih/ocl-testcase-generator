...
public class DempASTUtil {
  public static void main(String[] args) {
    ...
    /*
     * ------------------------------------------------------------------ 2. Clone test (a) create a
     * deep copy via clone() (b) confirm that the two trees are different objects
     * ------------------------------------------------------------------
     */
    ASTree astclone = ast.clone();

    System.out.println(
        "Clone success?  " + (ast != astclone && ast.toString().equals(astclone.toString())));
